...
past_lr=0.0003,0.0003,0.00003,0.00003,0.0003,0.00003
past_lamb=0,28.24295365,0.00364353889,0.00364354,0.0014924,0.0014924
best_lamb=0.0014924
start_model_path="${res_path}4.4.LA_phase.2/"
...
do
	...
	best_lr_id=1
	best_lamb=0.0014924 #0.00186549
	best_lamb_i=1
	
	la_model_path="${res_path}${id}.${best_lamb_i}.LA_phase.1/"
	
	## Lamb Down
	lamb_down=0.00000001
	elasticity_up_mult=0.0000001
	alpha_lamb_i=0
	found_best=false
