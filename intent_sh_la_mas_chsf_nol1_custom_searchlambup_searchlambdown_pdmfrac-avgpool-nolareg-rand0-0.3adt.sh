...
growth=0.9
# res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP30_${pdm_frac}pdmfrac${no_frel_cut_max}_AvgPoolNoLAReg/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lamb=0,0,1.3,0.225,0.225,0.00001 #t2:0.32346185, #t3:0.09135518 #t5:0.00006
best_lamb=0.225
# start_model_path="${res_path}1.1.LA_phase.7/"
# start_model_path="${res_path}2.1.LA_phase.15/" #"${res_path}2.1.LA_phase.7/"
...
###############################################################
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand0-0.3adt.sh random0 0 0 0.32346185 1641.28483697 1.0 1.0 0.8 True 0.3
