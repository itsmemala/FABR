...
no_frel_cut_max=$9
dataset='hwu64'
lr_array=(0.0003) #(0.00003 0.0003 0.003 0.03)
decay=0.9
acc_drop_threshold=${10}
growth=0.9
# base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP30_${pdm_frac}pdmfrac${no_frel_cut_max}_AvgPoolNoLAReg/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
# res_path="/content/gdrive/MyDrive/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP30_${pdm_frac}pdmfrac${no_frel_cut_max}_AvgPoolNoLAReg/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_Analysis/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lr=0,0,0.0003,0.0003 #,0.0003,0.0003 #t2:0.00003
past_lamb=0,0,1.3,0.225 #,0.225,0.00001 #t2:0.32346185, #t3:0.09135518/0.225 #t5:0.00006
best_lamb=0.225
# start_model_path="${base_res_path}1.1.LA_phase.7/"
start_model_path="${res_path}2.1.LA_phase.4/" # start_model_path="${res_path}2.1.LA_phase.15/" #"${res_path}2.1.LA_phase.7/"
# start_model_path="${res_path}3.13.LA_phase.17/"
...
# 	# cur_pdm_frac=1.0
# 	# alpha_lamb_i=14
# 	# #12:0.01,0.01,1.0 @ lr=0.0003 
# 	# #11:0.0001,0.1,1.0 @ lr=0.0003 (more forgetting for ~1.5 increase in FWT)
# 	# #10:0.0001,0.1 @ lr=0.0003 
# 	# # lamb_up=0.01 is needed for FWT?
# 	# #9:0.001,0.1 @ lr=0.0003 (same as #5) #8:0.01,0.05 @ lr=0.0003 #7:0.001,0.01,0.7 @ lr=0.0003 (similar high CF, worse FWT) #6:0.01,0.01 @ lr=0.0003 (CF increased alot) #5:0.01,0.1 @ lr=0.0003 
# 	# #4:0.1,0.1 @ lr=0.0003 #4:0.1,1.0 @ lr=0.0003 (val loss:2.6, val acc:14% @ 38 epochs) #3: 0.1, 1.0
# 	# found_best=false
# 	# while [ $found_best=false ]
# 	# do
# 	# 	((alpha_lamb_i++))
...
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 30 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine avg --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/ --start_at_task $id --start_model_path $start_model_path --elasticity_down_max_lamb $elasticity_up_max_lamb --elasticity_down_mult $elasticity_up_mult --elasticity_up $lamb_down --frel_cut_type pdm --pdm_frac $cur_pdm_frac --no_frel_cut_max $no_frel_cut_max --la_model_path $la_model_path --no_reg_in_LA True
...
# 	# Perform analysis to compare against ANCL at different thresholds
...
do
	...
	###############
	# Take best and look to reduce CF - increase lamb to 0.3 (based on lamb_results.png)
	...
	# # increase lamb to 0.35 (based on lamb_results.png)
	...
	# # increase lamb to 0.4 (based on lamb_results.png)
	...
	# increase lamb to 0.5 (based on lamb_results.png)
	...
	###############
	# Take best and look to reduce CF - increase lamb_up to 0.3, reset lamb to 0.225
...
# 	cur_pdm_frac=1.0
# 	alpha_lamb_i=16
# 	#16:lamb=0.225 #t3 perf = 70
# 	#15:lamb=0.25 #t3 perf = 60
# 	#14:lamb=0.3 #t3 perf = 55
# 	#13:lamb=0.4 #t3 perf = 53
# 	#12:lamb=0.2 #t3 perf = 75
# 	#11:lamb=1.5 #t3 perf = 12
# 	#10:lamb=2.0 #t3 perf = 0
# 	#9:0.001,0.05,1.0  (with updated t2 results) #t3 perf = 77
# 	#8:0.001,0.05,1.0 #7:0.001,0.05 (same as #6) #6:0.01,0.05
# 	found_best=false
# 	while [ $found_best=false ]
# 	do
# 		((alpha_lamb_i++))
...
# 	## Lamb Down
# 	lamb_down=0.001
# 	elasticity_up_mult=0.005
# 	cur_pdm_frac=1.0
# 	alpha_lamb_i=8
# 	#8:0.001,0.005,1.0 epochs=50 lamb=0.225 t4 perf=35
# 	#7:0.01,0.05,1.0 epochs=50 lamb=0.225 t4 perf=30
# 	#6:0.1,0.1,1.0 epochs=50 lamb=0.225 t4 perf=30
# 	#5:0.1,1.0,1.0 epochs=50 lamb=0.225 t4 perf=30
# 	#4:0.6,1.0,0.8 epochs=50 lamb=0.225 t4 perf=30
# 	#3:0.8,1.0,0.8 epochs=50 lamb=0.225 t4 perf=30
# 	#2:1.0,1.0,1.0 epochs=50 lamb=0.225 t4 perf=30
# 	#1:1.0,1.0,0.8 lamb=0.225 increased epochs t4 perf=30 (loss does not decrease beyond 50 epochs)
# 	#0:1.0,1.0,0.8 lamb=0.225 t4 perf=40
# 	found_best=false
# 	while [ $found_best=false ]
# 	do
# 		((alpha_lamb_i++))
...
# 		printf "\n\nLA Phase\n\n"
# 		mkdir -p ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/
# 		python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 35 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine avg --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/ --start_at_task $id --start_model_path $start_model_path --elasticity_down_max_lamb $elasticity_up_max_lamb --elasticity_down_mult $elasticity_up_mult --elasticity_up $lamb_down --frel_cut_type pdm --pdm_frac $cur_pdm_frac --no_frel_cut_max $no_frel_cut_max --la_model_path $la_model_path --no_reg_in_LA True --la_num_train_epochs 10
# 		python3 FABR/calc_next_lamb_down_lamb_up.py --my_save_path ${res_path}${id} --rand_idx $randid --seed $seed --dataset $dataset --best_lr_id $best_lr_id --best_lamb_i $best_lamb_i --alpha_lamb_i $alpha_lamb_i --lamb_down $lamb_down --elasticity_up_mult $elasticity_up_mult --growth $growth --tid $id
# 		found_best=`cat ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}_foundbestlambdown.txt`
# 		python3 FABR/plot_lamb_down_results.py --my_save_path ${res_path}${id} --rand_idx $randid --seed $seed --dataset $dataset --best_lamb_i $best_lamb_i --alpha_lamb_i $alpha_lamb_i --lamb_down $lamb_down --tid $id
# 		# if [ $found_best = found ]; then
...
# 	## Lamb Down
# 	lamb_down=0 #0.0000001
# 	elasticity_up_mult=0.0000000005
# 	cur_pdm_frac=1.0
# 	alpha_lamb_i=8
# 	#8:0,0.0000000005,1.0 (lamb=0.00001)
# 	#7:0,0.0000000005,1.0 (lamb=0.00006)
# 	found_best=false
# 	while [ $found_best=false ]
# 	do
# 		((alpha_lamb_i++))
...
# 		printf "\n\nLA Phase\n\n"
# 		mkdir -p ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/
# 		python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 35 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine avg --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/ --start_at_task $id --start_model_path $start_model_path --elasticity_down_max_lamb $elasticity_up_max_lamb --elasticity_down_mult $elasticity_up_mult --elasticity_up $lamb_down --frel_cut_type pdm --pdm_frac $cur_pdm_frac --no_frel_cut_max $no_frel_cut_max --la_model_path $la_model_path --no_reg_in_LA True --la_num_train_epochs 15
# 		python3 FABR/calc_next_lamb_down_lamb_up.py --my_save_path ${res_path}${id} --rand_idx $randid --seed $seed --dataset $dataset --best_lr_id $best_lr_id --best_lamb_i $best_lamb_i --alpha_lamb_i $alpha_lamb_i --lamb_down $lamb_down --elasticity_up_mult $elasticity_up_mult --growth $growth --tid $id
# 		found_best=`cat ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}_foundbestlambdown.txt`
# 		python3 FABR/plot_lamb_down_results.py --my_save_path ${res_path}${id} --rand_idx $randid --seed $seed --dataset $dataset --best_lamb_i $best_lamb_i --alpha_lamb_i $alpha_lamb_i --lamb_down $lamb_down --tid $id
# 		# if [ $found_best = found ]; then
...
###############################################################
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand0-0.3adt.sh random0 0 0 0.32346185 1641.28483697 1.0 1.0 0.8 True 0.3 # For t3 set lamb_max=1.3
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand3-0.3adt.sh random3 3 0 6.85163861 77.30662811 1.0 1.0 0.8 True 0.3
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand6-0.3adt.sh random6 6 0 28.24295365 246.34804902 1.0 1.0 0.8 True 0.3
