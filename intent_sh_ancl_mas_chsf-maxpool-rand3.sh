...
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLMAS_MaxPool/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_ANCLMAS_t"
base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLMAS/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_ANCLMAS_t"
...
# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --learning_rate $lr --remove_lr_schedule True --remove_wd True --ancl True --fisher_combine max --break_after_task 0 --my_save_path ${res_path}${id}_gold.${lr_id}/
# done
...
past_lamb=0,4.495360095,0.1
best_lamb=0.1
past_alpha_lamb=0,1.9

# start_model_path="${base_res_path}0_gold.1/"
start_model_path="${res_path}1.1.8/"
...
# 	# 	mkdir -p  ${res_path}${id}_gold.${lr_id}/
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}_gold.${lr_id}/ --start_at_task $id --start_model_path $start_model_path
# 	# done
...
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${lamb_i}/ --start_at_task $id --start_model_path $start_model_path
...
# 	## Alpha lamb
# 	alpha_lamb=1.9 #1.8,2.0,1.5,1.0,0.7,0.45,0.30912681 (new task perf drops at 1.0 #3??)
# 	alpha_lamb_i=7
# 	found_best=false
# 	while [ $found_best=false ]
# 	do
...
# 		python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.${alpha_lamb_i}/ --start_at_task $id --start_model_path $start_model_path
...
############
# bash intent_sh_ancl_mas_chsf-maxpool-rand3.sh random3 3 0 4.49536009 0.1