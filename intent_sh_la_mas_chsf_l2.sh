...
growth=0.1
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_L2/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lr=0.00003,0.00003,0.0003,0.0003
past_lamb=0,1.741594605202219,1.741594605202219,0.13892080693885117
start_model_path="${res_path}3.25.LA_phase/"
...
do
	...
	best_lr=${lr_array[$best_lr_id-1]}  # -1 for array indexing
	past_lr="$past_lr,$best_lr"
	start_lamb=0.13892080693885117 #t1:8.45881309935 #=0.9*0.9*0.9*prev_val
