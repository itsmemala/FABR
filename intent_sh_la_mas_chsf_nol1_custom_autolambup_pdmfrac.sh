...
do
	...
	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase/ --start_at_task $id --start_model_path $start_model_path --elasticity_down_max_lamb $elasticity_up_max_lamb --elasticity_down_mult $elasticity_up_mult --elasticity_up $lamb_down --frel_cut_type pdm --pdm_frac $pdm_frac --no_frel_cut_max $no_frel_cut_max
...
# CUDA_VISIBLE_DEVICES=1 bash FABR//intent_sh_la_mas_chsf_nol1_custom_autolambup_pdmfrac.sh random0 0 0 4.50567991 1641.28483697 1.0 1.0 1.0 True
# CUDA_VISIBLE_DEVICES=1 bash FABR//intent_sh_la_mas_chsf_nol1_custom_autolambup_pdmfrac.sh random3 3 0 6.85163861 77.30662811 1.0 1.0 1.0 True
# CUDA_VISIBLE_DEVICES=1 bash FABR//intent_sh_la_mas_chsf_nol1_custom_autolambup_pdmfrac.sh random6 6 0 1823.64981886 2026.27757651 1.0 1.0 1.0 True