...
class MyBertSelfOutput(BertSelfOutput):
    def __init__(self, config,args):
        ...
        if args.use_imp:
            ...
            from networks.adapters import BertAdapterCapsuleMaskImp as BertAdapterCapsuleMask
            from networks.adapters import BertAdapterCapsuleImp as BertAdapterCapsule
        else:
            # from networks.base.adapters import BertAdapterCapsuleMask
            # from networks.base.adapters import BertAdapterCapsule
            from networks.adapters import BertAdapterCapsuleMask
            from networks.adapters import BertAdapterCapsule
