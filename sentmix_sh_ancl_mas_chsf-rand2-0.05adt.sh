...
res_path="/home/local/data/ms/fabr_data/SentMixSH/SentMixSH_ANCLMAS/${note}seed${seed}_${acc_drop_threshold}adt/SentMixSH_ANCLMAS_t"
...
# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment sent_mix --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario dil --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --learning_rate $lr --remove_lr_schedule True --remove_wd True --ancl True --break_after_task 0 --my_save_path ${res_path}${id}_gold.${lr_id}/ --only_mcl True
# done

# python3 FABR/return_best_lr.py --my_save_path ${res_path}${id}_gold --rand_idx $randid --seed $seed --dataset $dataset --max_lr_id 2 --tid $id
# best_lr_id=$?
...
past_lamb=0,500,5,5
best_lamb=5
past_alpha_lamb=0,0.01,0.014641,0.0121
# start_model_path="${res_path}0_gold.1/"
# start_model_path="${res_path}1.1.1/"
start_model_path="${res_path}3.1.3/"
...
# 	# 	mkdir -p  ${res_path}${id}_gold.${lr_id}/
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment sent_mix --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario dil --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}_gold.${lr_id}/ --start_at_task $id --start_model_path $start_model_path --only_mcl True
# 	# done
...
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment sent_mix --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario dil --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${lamb_i}/ --start_at_task $id --start_model_path $start_model_path --only_mcl True
...
################################
# bash sentmix_sh_ancl_mas_chsf-rand2-0.05adt.sh random2 2 0 500.0 0.05