...
res_path="/content/gdrive/MyDrive/fabr_data/SentMixSH/SentMixSH_ANCLLWF/${note}seed${seed}_${acc_drop_threshold}adt/SentMixSH_ANCLLWF_t"
...
# 	# python  FABR//run.py --bert_model 'bert-base-uncased' --experiment sent_mix --approach bert_adapter_lwf_ancl --baseline lwf_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario dil --train_batch_size 128 --eval_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --learning_rate $lr --remove_lr_schedule True --remove_wd True --lwf_ancl True --lwf_T 2 --break_after_task 0 --my_save_path ${res_path}${id}_gold.${lr_id}/
...
##
# bash sentmix_sh_ancl_lwf_chsf-rand0-0.05adt.sh random0 0 0 1000 0.05
# bash sentmix_sh_ancl_lwf_chsf-rand1-0.05adt.sh random1 1 0 1000 0.05
# bash sentmix_sh_ancl_lwf_chsf-rand2-0.05adt.sh random2 2 0 1000 0.05
