...
growth=0.9
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixed_${pdm_frac}pdmfrac${no_frel_cut_max}_AvgPool/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"

past_lr=0.0003,0.0003,0.0003,0.0003
past_lamb=0,28.24295365,2.02755596,2.02755596
best_lamb=2.02755596
start_model_path="${res_path}2.26.LA_phase.1/"
