...
growth=0.1
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom2/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lamb=0,6.85163861,6.85163861
start_model_path="${res_path}2.1.LA_phase/"
start_lamb=$custom_max_lamb
...
do
	...
	best_lr=${lr_array[$best_lr_id-1]}  # -1 for array indexing
	past_lr="$past_lr,$best_lr"
	# start_lamb=11.603310152220002 #=0.9*0.9*0.9*prev_val
