...
past_lamb=0,29.95017167
past_alpha_lamb=0,0.02593742
start_model_path="${res_path}1.40.11/" # chose this alpha_lamb based on plot, further search had decreasing results

best_lamb=29.95017167
