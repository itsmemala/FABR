...
past_lamb=0,6.85163861,6.85163861,6.85163861
start_model_path="${res_path}2.1.LA_phase.36/"
...
# CUDA_VISIBLE_DEVICES=0 bash FABR//intent_sh_la_mas_chsf_nol1_custom_autolambup_searchlambdown_pdmfrac-rand3.sh random3 3 0 6.85163861 77.30662811 1.0 1.0 0.9 True
