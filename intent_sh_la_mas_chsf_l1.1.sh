...
growth=0.1
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_L1.1/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
# do
	...
	# CUDA_VISIBLE_DEVICES=0 python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 5 --learning_rate $lr --fisher_combine max --use_l1 True --l1_lamb 0.0000075 --break_after_task 0 --my_save_path ${res_path}${id}_gold.${lr_id}/ --only_mcl True
...
past_lr=0.0003,0.0003,0.0003,0.0003,0.00003,0.0003
past_lamb=0,515.05257304,117.82750817,0.92555478,0.01876614
start_model_path="${res_path}4.38.LA_phase/"
...
do
	...
	best_lr_id=2
	start_lamb=0.000579933351 #=0.9*0.9*0.9*0.9*prev
