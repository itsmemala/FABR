...
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLLWF/${note}seed${seed}_${acc_drop_threshold}adt_t4onwards/IntentSH_ANCLLWF_t"
...
past_lr=1,1,1,1
past_lamb=0,0.456775907,0.9550049507968267,1.4555783429306912
past_alpha_lamb=0,0.14420993610649954,0.01,0.01
start_model_path="${res_path}3.63.1/"
start_lamb=3

id_array=(4 5) #(1 2 3 4 5)
for id in "${id_array[@]}"
do
