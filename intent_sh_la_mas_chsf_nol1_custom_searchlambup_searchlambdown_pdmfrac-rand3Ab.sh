...
growth=0.8
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP10_${pdm_frac}pdmfrac${no_frel_cut_max}/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lr=0.00003,0.00003,0.0003,0.00003
past_lamb=0,4.495360095,2.94940576,0.92555478
best_lamb=0.92555478
start_model_path="${res_path}2.6.LA_phase.2/"
...
do
	...
	do
		...
		python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 20 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase.${alpha_lamb_i}/ --start_at_task $id --start_model_path $start_model_path --elasticity_down_max_lamb $elasticity_up_max_lamb --elasticity_down_mult $elasticity_up_mult --elasticity_up $lamb_down --frel_cut_type pdm --pdm_frac $pdm_frac --no_frel_cut_max $no_frel_cut_max --la_model_path $la_model_path
...
# CUDA_VISIBLE_DEVICES=0 bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random0 0 0 10.0 572.28063672 1.0 1.0 0.9 True 0.3 # 0.32346185 1641.28483697
# CUDA_VISIBLE_DEVICES=0 bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random3 3 0 50.0 77.30662811 1.0 1.0 0.9 True 0.3 # 6.85163861 77.30662811
# CUDA_VISIBLE_DEVICES=1 bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random6 6 0 100.0 246.34804902 1.0 1.0 0.9 True 0.3 # 1823.64981886 2026.27757651
...
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random0 0 0 0.04854989 572.28063672 1.0 1.0 0.9 True 0.1 #0.32346185 1641.28483697
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random3 3 0 4.49536009 77.30662811 1.0 1.0 0.9 True 0.1
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random6 6 0 28.24295365 246.34804902 1.0 1.0 0.9 True 0.1

#########
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random3 3 0 4.49536009 77.30662811 1.0 1.0 0.8 True 0.1
# bash intent_sh_la_mas_chsf_nol1_custom_ss_analysis_pdmfrac-rand6-0.1adt-0.8pdm.sh random6 6 0 28.24295365 246.34804902 1.0 1.0 0.8 True 0.1


#########

# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random0 0 0 0.04854989 572.28063672 1.0 1.0 0.7 True 0.1
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random3 3 0 4.49536009 77.30662811 1.0 1.0 0.7 True 0.1
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random6 6 0 28.24295365 246.34804902 1.0 1.0 0.7 True 0.1