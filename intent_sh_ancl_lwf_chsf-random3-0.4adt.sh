...
decay=0.9
acc_drop_threshold=0.4
growth=0.1
start_lamb=$4
start_alpha_lamb=0.01
base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLLWF/random3seed0_0.1adt/IntentSH_ANCLLWF_t"
...
#######
# bash intent_sh_ancl_lwf_chsf-random3-0.4adt.sh random3 3 0 0.5075
