...
growth=0.1
# res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
res_path="/content/gdrive/MyDrive/fabr_data/IntentSH/IntentSH_LAMAS_NoL1/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
past_lr=0.0003,0.0003,0.00003,0.0003,0.0003
past_lamb=0,1823.64981886,0.00997309678,0.0099731,0.0099731
start_model_path="${res_path}4.1.LA_phase/"
...
do
	...
	best_lr=${lr_array[$best_lr_id-1]}  # -1 for array indexing
	past_lr="$past_lr,$best_lr"
	start_lamb=$custom_max_lamb #=0.9*0.9*0.9*0.9*0.9*prev_val
