...
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLMAS/${note}seed${seed}_${acc_drop_threshold}adt_t1onwards/IntentSH_ANCLMAS_t"
...
past_lamb=0,28.24295365,8.86293812,1.33027946,1.33027946
past_alpha_lamb=0,0.011,4.45791571,0.11918177,0.2810243699490025
start_model_path="${res_path}4.1.10/" #"${res_path}0_gold.1/"
custom_max_lamb=1.33027946 #28.24295365 #100
