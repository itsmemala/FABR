...
past_lamb=0,28.24295365
past_alpha_lamb=0,0.011
start_model_path="${res_path}1.13.2/" #"${res_path}0_gold.1/"
custom_max_lamb=28.24295365 #100
...
do
	...
	best_lr=${lr_array[$best_lr_id-1]}  # -1 for array indexing
	past_lr="$past_lr,$best_lr"
	best_lamb=8.86293812
	best_lamb_i=12
	past_lamb="$past_lamb,$best_lamb"
	start_alpha_lamb=0.119181766
