...
growth=0.1
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_AvgPool/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
start_model_path="${res_path}3.1.LA_phase/"
