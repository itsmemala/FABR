...
res_path="/home/local/data/ms/fabr_data/sent_mixSH/sent_mixSH_ANCLMAS/${note}seed${seed}_${acc_drop_threshold}adt/sent_mixSH_ANCLMAS_t"
...
past_lamb=0,500,500,32.805
best_lamb=32.805
past_alpha_lamb=0,0.01,0.01,0.01
# start_model_path="${res_path}0_gold.1/"
# start_model_path="${res_path}1.6.1/"
# start_model_path="${res_path}2.1.1/"
start_model_path="${res_path}3.9.1/"
...
##########
# bash sent_mix_sh_ancl_mas_chsf-rand0-0.05adt.sh random0 0 0 500.0 0.05