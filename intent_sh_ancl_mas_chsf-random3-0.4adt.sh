...
base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLMAS/random3seed0_0.1adt/IntentSH_ANCLMAS_t"
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_ANCLMAS/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_ANCLMAS_t"
...
past_lamb=0,21.83,10.44,1.0284262,1.0284262
past_alpha_lamb=0,0,2.9282,0.01
# start_model_path="${base_res_path}0_gold.1/"
# start_model_path="${res_path}1.1.5/"
# start_model_path="${res_path}2.8.22/"
start_model_path="${res_path}3.21.1/"
...
# 	# 	custom_lr="$past_lr,$lr"
# 	# 	mkdir -p  ${res_path}${id}_gold.${lr_id}/
# 	# 	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_ancl --imp function --baseline ewc_ancl --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --la_num_train_epochs 1 --valid_loss_es 0.002 --lr_patience 5 --custom_lr $custom_lr --remove_lr_schedule True --remove_wd True --custom_lamb $custom_lamb --custom_alpha_lamb $custom_alpha_lamb --ancl True --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}_gold.${lr_id}/ --start_at_task $id --start_model_path $start_model_path
# 	# done
...
#######
# bash intent_sh_ancl_mas_chsf-random3-0.4adt.sh random3 3 0 21.83 0.4
