...
###############################################################
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand3-0.75pdm.sh random3 3 0 4.49536009 77.30662811 1.0 1.0 0.75 True 0.1