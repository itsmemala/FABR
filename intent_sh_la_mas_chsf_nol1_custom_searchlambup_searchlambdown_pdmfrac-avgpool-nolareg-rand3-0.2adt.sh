...
growth=0.9
base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP10_0.8pdmfrac${no_frel_cut_max}_AvgPoolNoLAReg/${note}seed${seed}_0.1adt/IntentSH_LAMAS_t"
...
###############################################################
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand3-0.2adt.sh random3 3 0 6.85163861 77.30662811 1.0 1.0 0.8 True 0.2
