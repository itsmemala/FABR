...
growth=0.1
res_path="/home/local/data/ms/fabr_data/BehavSH/BehavSH_LAMAS_NoL1_EKTO.1.4/${note}seed${seed}_${acc_drop_threshold}adt/BehavSH_LAMAS_t"
base_res_path="/home/local/data/ms/fabr_data/BehavSH/BehavSH_LAMAS_NoL1_EKTO.1/${note}seed${seed}_${acc_drop_threshold}adt/BehavSH_LAMAS_t"
