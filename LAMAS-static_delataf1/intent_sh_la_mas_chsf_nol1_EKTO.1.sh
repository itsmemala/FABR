...
growth=0.1
res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_EKTOFixedLrP20_NoLAReg.1${name_ext}/${note}seed${seed}_${acc_drop_threshold}adt/IntentSH_LAMAS_t"
...
do
	...
	python  FABR//run.py --bert_model 'bert-base-uncased' --experiment hwu64 --approach bert_adapter_ewc_freeze --imp function --baseline ewc_freeze --backbone bert_adapter --note $note --idrandom $randid --seed $seed --scenario cil --use_rbs True --train_batch_size 128 --num_train_epochs 50 --valid_loss_es 0.002 --lr_patience 25 --custom_lr $custom_lr --custom_lamb $custom_lamb --fisher_combine max --break_after_task $id --save_alpharel True --my_save_path ${res_path}${id}.${best_lamb_i}.LA_phase/ --start_at_task $id --start_model_path $start_model_path --adapt_type orig_enablektonly --elasticity_up 1 --frel_cut $frel_cut --no_reg_in_LA True --la_model_path $la_model_path
		
	start_model_path="${res_path}${id}.${best_lamb_i}.LA_phase/"
done


# bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 .1 0.1 && bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 .5 0.2 && bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 .2 0.3 && bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 "" 0.5 && bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 .3 0.7 && bash intent_sh_la_mas_chsf_nol1_EKTO.1.sh random3 3 0 6.85163861 .4 0.9
# bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 .1 0.1 && bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 .5 0.2 && bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 .2 0.3 && bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 "" 0.5 && bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 .3 0.7 && bash intent_sh_la_mas_chsf_nol1_EKTO.2.sh random3 3 0 6.85163861 .4 0.9
# bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 .1 0.1 && bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 .5 0.2 && bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 .2 0.3 && bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 "" 0.5 && bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 .3 0.7 && bash intent_sh_la_mas_chsf_nol1_EKTO.3.sh random3 3 0 6.85163861 .4 0.9
# bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 .1 0.1 && bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 .5 0.2 && bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 .2 0.3 && bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 "" 0.5 && bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 .3 0.7 && bash intent_sh_la_mas_chsf_nol1_EKTO.4.sh random3 3 0 6.85163861 .4 0.9
# bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 .1 0.1 && bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 .5 0.2 && bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 .2 0.3 && bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 "" 0.5 && bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 .3 0.7 && bash intent_sh_la_mas_chsf_nol1_EKTO.5.sh random3 3 0 6.85163861 .4 0.9