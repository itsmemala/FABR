...
growth=0.9
base_res_path="/home/local/data/ms/fabr_data/IntentSH/IntentSH_LAMAS_NoL1_Custom_ssFixedLrP10_0.8pdmfracTrue_AvgPoolNoLAReg/random3seed0_0.1adt/IntentSH_LAMAS_t"
...
past_lamb=0,21.83,21.83,21.83,21.83
best_lamb=21.83
# start_model_path="${base_res_path}0_gold.1/"
start_model_path="${res_path}3.1.LA_phase.11/"
...
###############################################################
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand3-0.4adt.sh random3 3 0 21.83 77.30662811 1.0 1.0 0.8 True 0.4
