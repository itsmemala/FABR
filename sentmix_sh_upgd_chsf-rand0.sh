...
##############
# CUDA_VISIBLE_DEVICES=0 bash sentmix_sh_upgd_chsf.sh random0 0 0 False
# CUDA_VISIBLE_DEVICES=0 bash sentmix_sh_upgd_chsf.sh random1 1 0 False
# CUDA_VISIBLE_DEVICES=0 bash sentmix_sh_upgd_chsf.sh random2 2 0 False