...
past_lamb=0,4.50567991,1.57103344,1.27253709,1.27253709,1.27253709
past_alpha_lamb=0,0.0121,0.17449402,0.03797498,0.0121
start_model_path="${res_path}4.1.3/"
# custom_max_lamb=200
best_lr_id=1
best_lamb_i=1
start_alpha_lamb=0.0161051
