...
past_lamb=0,28.24295365,13.5 #,13.5
best_lamb=13.5
start_model_path="${res_path}1.1.LA_phase.3/"
start_model_path="${res_path}2.6.LA_phase.38/"
...
# bash intent_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac-avgpool-nolareg-rand6.sh random6 6 0 28.24295365 246.34804902 1.0 1.0 0.8 True 0.1
