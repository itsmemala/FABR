...
# CUDA_VISIBLE_DEVICES=0 bash behav_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random13 13 0 0.2027556 10.0 1.0 1.0 0.9 True 0.3

# CUDA_VISIBLE_DEVICES=0 bash behav_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random0 0 0 0.58149737 10.0 1.0 1.0 0.9 True 0.2
...
# bash behav_sh_la_mas_chsf_nol1_custom_searchlambup_searchlambdown_pdmfrac.sh random13 13 0 0.0925554779 10.0 1.0 1.0 0.9 True 0.05